...
INSERT INTO z_user (id, username, pwd, phone, nickname, sex, birthday, logo, id_card, email, update_time, del_flag,
                    create_id, update_id)
VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '13800138001', '管理员', '男', '1990-01-01', NULL,
        '110101199001011234', 'admin@example.com', NOW(), FALSE, NULL, NULL),
       (2, 'testuser1', 'e10adc3949ba59abbe56e057f20f883e', '13800138002', '测试用户1', '女', '1992-05-15', NULL,
        '110101199205151234', 'test1@example.com', NOW(), FALSE, 1, 1),
       (3, 'testuser2', 'e10adc3949ba59abbe56e057f20f883e', '13800138003', '测试用户2', '男', '1988-12-20', NULL,
        '110101198812201234', 'test2@example.com', NOW(), FALSE, 1, 1),
       (4, 'testuser3', 'e10adc3949ba59abbe56e057f20f883e', '13800138004', '测试用户3', '未知', '1995-08-10', NULL,
        '110101199508101234', 'test3@example.com', NOW(), FALSE, 1, 1),
       (5, 'testuser4', 'e10adc3949ba59abbe56e057f20f883e', '13800138005', '测试用户4', '女', '1993-03-25', NULL,
        '110101199303251234', 'test4@example.com', NOW(), FALSE, 1, 1),
       (6, 'testuser5', 'e10adc3949ba59abbe56e057f20f883e', '13800138006', '测试用户5', '男', '1991-11-30', NULL,
        '110101199111301234', 'test5@example.com', NOW(), FALSE, 1, 1),
       (7, 'testuser6', 'e10adc3949ba59abbe56e057f20f883e', '13800138007', '测试用户6', '女', '1994-07-14', NULL,
        '110101199407141234', 'test6@example.com', NOW(), FALSE, 1, 1),
       (8, 'testuser7', 'e10adc3949ba59abbe56e057f20f883e', '13800138008', '测试用户7', '未知', '1989-09-05', NULL,
        '110101198909051234', 'test7@example.com', NOW(), FALSE, 1, 1),
       (9, 'testuser8', 'e10adc3949ba59abbe56e057f20f883e', '13800138009', '测试用户8', '男', '1996-02-18', NULL,
        '110101199602181234', 'test8@example.com', NOW(), FALSE, 1, 1),
       (10, 'testuser9', 'e10adc3949ba59abbe56e057f20f883e', '13800138010', '测试用户9', '女', '1997-06-22', NULL,
